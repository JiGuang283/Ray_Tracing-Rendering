...
![alt text](images/scene40_integrator4_1765883754.png)

> 该场景展示了渲染器对多种不同类型光源的混合渲染能力。场景中包含四种光源：
> 1. **聚光灯 (Spot Light)**：作为主光源从上方照射中间的金球，产生边缘清晰的圆形光斑。
> 2. **面光源 (Quad Light)**：位于右上方作为柔光箱，在金球表面形成矩形高光，并投射出柔和的软阴影。
> 3. **点光源 (Point Light)**：位于右侧的暖色补光，照亮红色球体的侧面，增强立体感。
> 4. **平行光 (Directional Light)**：微弱的冷蓝色背光，模拟夜间环境光，勾勒物体轮廓并填充阴影区域。
...
> - 被遮挡单一光源的区域显示其**补色**（青、品红、黄）
> - 完全被遮挡的区域为黑色（本影），三色叠加区域为白色

### 5.6 场景 6：无限镜屋

![alt text](images/scene42_integrator4_1765884768.png)

> 展示光线追踪的**递归反射**能力：
> - 由完美镜面构成的封闭房间
> - 三个彩色发光球体作为光源
> - 光线在镜面间多次反射，产生无限延伸的视觉效果
